...
import com.kemarport.kyms.viewmodel.export.EdiDetailsVMProviderFactory
import com.kemarport.kyms.viewmodel.export.EdiDetailsViewModel
...
//    }
    ...
    fun setBarcode(data: String?) {
        ...
        (activity as FragmentHostActivity).runOnUiThread {
            if (transportationMode ==Constants. MODE_TRAIN) {
                viewModel.unloadingCoil(jwtToken, scannedBarcode, rakeRefNo, jobId, baseUrl)
            } else if (transportationMode == Constants.MODE_TRUCK) {
