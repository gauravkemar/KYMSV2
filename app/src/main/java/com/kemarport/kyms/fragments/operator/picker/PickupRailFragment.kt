...
import com.kemarport.kyms.helper.Constants.Companion.DEFAULT_LOCATION_RAIL
import com.kemarport.kyms.helper.Resource
import com.kemarport.kyms.models.CoilData.CoilData
import com.kemarport.kyms.models.EDI.Coil
import com.kemarport.kyms.models.EDI.EdiConfirmationRequest
import com.kemarport.kyms.repository.KYMSRepository
import com.kemarport.kyms.viewmodel.PickupRailVMProviderFactory
import com.kemarport.kyms.viewmodel.PickupRailViewModel
...
class PickupRailFragment : Fragment(), View.OnClickListener {
    ...
    private val locationNames = mutableListOf(DEFAULT_LOCATION_RAIL)
