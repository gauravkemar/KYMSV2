...
class VesselLoadingViewModel(
    ...
    fun loadingOnVessel(
        token: String?,
        vesselAndIntercartingRequest: com.kemarport.kyms.models.export.vesselandintercarting.VesselAndIntercartingRequest,
        baseUrl: String
    ) = viewModelScope.launch {
    ...
    private suspend fun safeAPICallLoadingOnVessel(
        ...
        try {
            if (hasInternetConnection()) {
                ...
                loadingOnVesselMutableLiveData.postValue(Resource.Error(Constants.NO_INTERNET))
            }
        } catch (t: Throwable) {
            when (t) {
    ...
    val packingListMutableLiveData: MutableLiveData<Resource<com.kemarport.kyms.models.export.packingList.PackingListResponse>> =
        MutableLiveData()
    ...
    private suspend fun safeAPICallPackingList(
        ...
        try {
            if (hasInternetConnection()) {
                ...
                packingListMutableLiveData.postValue(Resource.Error(Constants.NO_INTERNET))
            }
        } catch (t: Throwable) {
            when (t) {
    ...
    private fun handlePackingListResponse(response: Response<com.kemarport.kyms.models.export.packingList.PackingListResponse>): Resource<com.kemarport.kyms.models.export.packingList.PackingListResponse> {
        var errorMessage = ""
        if (response.isSuccessful) {
            response.body()?.let { generalResponse ->
                return Resource.Success(generalResponse)
    ...
    val packingListDetailsMutableLiveData: MutableLiveData<Resource<com.kemarport.kyms.models.export.loadedCoils.CurrentLoadingResponse>> =
        MutableLiveData()
    ...
    private suspend fun safeAPICallPackingListDetails(
        ...
        try {
            if (hasInternetConnection()) {
                ...
                packingListDetailsMutableLiveData.postValue(Resource.Error(Constants.NO_INTERNET))
            }
        } catch (t: Throwable) {
            when (t) {
    ...
    private fun handlePackingListDetailsResponse(response: Response<com.kemarport.kyms.models.export.loadedCoils.CurrentLoadingResponse>): Resource<com.kemarport.kyms.models.export.loadedCoils.CurrentLoadingResponse> {
        var errorMessage = ""
        if (response.isSuccessful) {
            response.body()?.let { generalResponse ->
                return Resource.Success(generalResponse)
    ...
    val dischargePortListMutableLiveData: MutableLiveData<Resource<com.kemarport.kyms.models.export.packingList.DischargePortResponse>> =
        MutableLiveData()
    ...
    private suspend fun safeAPICallDischargePortList(
        ...
        try {
            if (hasInternetConnection()) {
                ...
                dischargePortListMutableLiveData.postValue(Resource.Error(Constants.NO_INTERNET))
            }
        } catch (t: Throwable) {
            when (t) {
    ...
    private fun handleDischargePortListResponse(response: Response<com.kemarport.kyms.models.export.packingList.DischargePortResponse>): Resource<com.kemarport.kyms.models.export.packingList.DischargePortResponse> {
        var errorMessage = ""
        if (response.isSuccessful) {
            response.body()?.let { generalResponse ->
                return Resource.Success(generalResponse)
